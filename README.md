...
After creating an empty new Spring project in IntelliJ through the _Spring Initializer Template_: [#1 Hello Spring](https://github.com/Dat17B/spring_agenda_01_hello/blob/master/README.md), you should now create your first _Hello World Website_.    
